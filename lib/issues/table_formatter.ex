defmodule Issues.TableFormatter do
  ...
  @doc """
  Takes a list of raw data, where each row is a HashDict, and a list of headers. Prints a table to STDOUT of the data from each row identified by each header. I.e., each header identifies a column, and those columns are extracted and printed from the rows.
  ...
  @doc """
  Generate the line that goes below the column headings. It's a string of hyphens, with + signs for the column delimiters.
  ## Example
  iex> widths = [5,6,9]
